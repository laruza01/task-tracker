...
<body>
    <div class="parent">
        <div class="app-header">
            ...
            <div class="logo"> <a href="dashboard.php"> <img src="images/calendar.png" alt="Logo Icon"> <span>Task Tracker</span> </a> </div>
            <div class="app-menu">
                <ul>
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                        <a class="nav-link" href="view-all-task.php">View All Task</a>
                        </li>
                        <li class="nav-item">
